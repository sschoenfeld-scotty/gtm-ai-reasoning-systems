...
Full Stack v5 crossed the version threshold by adding Strategic Adjudication to the architecture developed through v4.

> **A correct diagnosis is necessary for a good decision. It does not make every diagnosed problem worth solving.**

Full Stack v5.1 preserves that reasoning spine and adds Compressed Diagnosis.
...
- [Choice Architecture Framework Sufficiency Test](evidence/2026-09-26-choice-architecture-framework-sufficiency-test.md) records a controlled fresh-context comparison of current Human Pattern 1 against an explicit choice-architecture candidate. One material confidence-separation improvement and one smaller attribution-discipline improvement were observed, but repeated decision-level improvement was not established. The candidate remains a working hypothesis and no canonical Full Stack change was made.
...
For Full Stack v5.1, the next major work is evidence about Compressed Diagnosis and continued evaluation of the retained v5 capabilities rather than another version number.
