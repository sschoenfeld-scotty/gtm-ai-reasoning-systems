...
- [Executive Investment Decision Readiness Case](examples/executive-investment-decision-readiness-applied-case.md) records an anonymized retrospective applied case where a human-directed Full Stack v5 and GTM v9 process materially changed the decision architecture around an already strong executive investment thesis while preserving the framework failure and human correction that occurred during the work.
