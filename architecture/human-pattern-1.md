...
At the time of this note's most recent verification, Full Stack v5.1 is the current canonical Full Stack framework. The v5.1 change adds Compressed Diagnosis without replacing Human Pattern 1 or lowering the evidence standard for motive and causality. If the canonical framework changes again, this public derivative should be rechecked for fidelity before the newer version is assumed to preserve Human Pattern 1 unchanged.
